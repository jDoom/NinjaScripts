...
{
	public class VolumetricHighlightExample : Indicator
	{
		...
		protected override void OnStateChange()
		{
			if (State == State.SetDefaults)
			{
				...
				Name						= "VolumetricHighlightExample";
			...
			else if (State == State.DataLoaded)
			{
		        ...
		        if (barsType == null)
				{
					...
					{      
						...
						"This example is for use on Volumetric Bars only", "VolumetricHighlightExample", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.None);
					}));
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private CustomRenderingExamples.VolumetricHighlightExample[] cacheVolumetricHighlightExample;
		public CustomRenderingExamples.VolumetricHighlightExample VolumetricHighlightExample()
		{
			return VolumetricHighlightExample(Input);
		}

		public CustomRenderingExamples.VolumetricHighlightExample VolumetricHighlightExample(ISeries<double> input)
		{
			if (cacheVolumetricHighlightExample != null)
				for (int idx = 0; idx < cacheVolumetricHighlightExample.Length; idx++)
					if (cacheVolumetricHighlightExample[idx] != null &&  cacheVolumetricHighlightExample[idx].EqualsInput(input))
						return cacheVolumetricHighlightExample[idx];
			return CacheIndicator<CustomRenderingExamples.VolumetricHighlightExample>(new CustomRenderingExamples.VolumetricHighlightExample(), input, ref cacheVolumetricHighlightExample);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.CustomRenderingExamples.VolumetricHighlightExample VolumetricHighlightExample()
		{
			return indicator.VolumetricHighlightExample(Input);
		}

		public Indicators.CustomRenderingExamples.VolumetricHighlightExample VolumetricHighlightExample(ISeries<double> input )
		{
			return indicator.VolumetricHighlightExample(input);
		}
	}
