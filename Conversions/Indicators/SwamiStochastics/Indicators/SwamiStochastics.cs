...
{
	public class SwamiStochastics : Indicator
	{
		...
		protected override void OnStateChange()
		{
			...
			{
				Description									= @"Stocks and Commodities - March 2012 - Introducing SwamiCharts";
				Name										= "SwamiStochastics";
				...
				NeutralColor								= System.Windows.Media.Brushes.Yellow;
		...
		protected override void OnBarUpdate()
		{
			...
			for (int x = 0; x < iValues.Length; x++)
				iValues[x][0] = Stochastics(3, x + MinLength, 3)[0] * 0.01;
		}
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private SwamiStochastics[] cacheSwamiStochastics;
		public SwamiStochastics SwamiStochastics(int minLength, int maxLength, System.Windows.Media.Brush bearishColor, System.Windows.Media.Brush bullishColor, System.Windows.Media.Brush neutralColor)
		{
			return SwamiStochastics(Input, minLength, maxLength, bearishColor, bullishColor, neutralColor);
		}

		public SwamiStochastics SwamiStochastics(ISeries<double> input, int minLength, int maxLength, System.Windows.Media.Brush bearishColor, System.Windows.Media.Brush bullishColor, System.Windows.Media.Brush neutralColor)
		{
			if (cacheSwamiStochastics != null)
				for (int idx = 0; idx < cacheSwamiStochastics.Length; idx++)
					if (cacheSwamiStochastics[idx] != null && cacheSwamiStochastics[idx].MinLength == minLength && cacheSwamiStochastics[idx].MaxLength == maxLength && cacheSwamiStochastics[idx].BearishColor == bearishColor && cacheSwamiStochastics[idx].BullishColor == bullishColor && cacheSwamiStochastics[idx].NeutralColor == neutralColor && cacheSwamiStochastics[idx].EqualsInput(input))
						return cacheSwamiStochastics[idx];
			return CacheIndicator<SwamiStochastics>(new SwamiStochastics(){ MinLength = minLength, MaxLength = maxLength, BearishColor = bearishColor, BullishColor = bullishColor, NeutralColor = neutralColor }, input, ref cacheSwamiStochastics);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.SwamiStochastics SwamiStochastics(int minLength, int maxLength, System.Windows.Media.Brush bearishColor, System.Windows.Media.Brush bullishColor, System.Windows.Media.Brush neutralColor)
		{
			return indicator.SwamiStochastics(Input, minLength, maxLength, bearishColor, bullishColor, neutralColor);
		}

		public Indicators.SwamiStochastics SwamiStochastics(ISeries<double> input , int minLength, int maxLength, System.Windows.Media.Brush bearishColor, System.Windows.Media.Brush bullishColor, System.Windows.Media.Brush neutralColor)
		{
			return indicator.SwamiStochastics(input, minLength, maxLength, bearishColor, bullishColor, neutralColor);
		}
	}
